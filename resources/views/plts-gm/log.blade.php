    ...
    <div class="col-12 col-md-6 col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4>Logsheet</h4>
                <a href="#" class="btn btn-success btn-export" data-cat="nar-log"><i class="fa fa-print"></i> Export</a>
            </div>
            <div class="card-body">
...
<script>
    ...
    function loadData() {
        $.ajax({
            type: 'GET',
            url: "{{ url('plts-gm/log/load-data?inverter_id='.$inverter_id) }}",
            success: function (r) {
                console.log(r)
    ...
    $(document).on('click', '.btn-submit-export', function (e) {
        e.preventDefault()
        url = "{{ url('plts-gm/log/export') }}" + '?date=' + $('#date').val()
