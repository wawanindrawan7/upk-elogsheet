                                ...
                                <div class="wizard-steps">
                                    <div class="wizard-step wizard-step-active">
                                        ...
                                        <div class="wizard-step-label">
                                            <a href="{{ url('plts-ga/log?inverter_id=1') }}" class="text-white">MESIN 1</a>
                                        </div>
                                    </div>
                                    <div class="wizard-step wizard-step-active">
                                        <div class="wizard-step-icon">
                                        ...
                                        <div class="wizard-step-label">
                                            <a href="{{ url('plts-ga/log?inverter_id=2') }}" class="text-white">
                                                MESIN 2</a>
                                        </div>
                                    </div>
...
<script>
    ...
    $(document).on('click', '.btn-submit-export', function (e) {
        e.preventDefault()
        url = "{{ url('plts-ga/log/export-all') }}" + '?date=' + $('#date').val()
