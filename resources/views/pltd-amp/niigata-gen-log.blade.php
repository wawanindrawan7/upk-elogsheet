    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="cari-modal">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form method="get" action="{{ url('pltd-amp/niigata/gen-log') }}">
                    @csrf
                        ...
                        <table id="dataTable" class="table table-bordered table-md">
                            <thead>
                                <tr align="center">
                                    ...
                                    <td colspan="10" align="center"><b>Generator</b></td>
                                ...
                                <tr align="center">
                                    ...
                                    <td align="center" colspan="3" width="15%">Arus (kA)</td>
                                    <td colspan="2" width="5%">Penguat Medan</td>
                                </tr>
                                <tr align="center">
                                    <td>R</td>
                                    <td>S</td>
...
@section('js')
    ...
    <script>
        ...
        function loadData() {
            ...
            $.ajax({
                type: 'GET',
                url: "{{ url('pltd-amp/niigata/gen-log/load-data?unit_id=') }}" + unit_id + "&date=" +
