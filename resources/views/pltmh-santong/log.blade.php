    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="cari-modal">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form method="get" action="{{ url('pltmh-santong/log') }}">
                    @csrf
...
@section('js')
    ...
    <script>
        ...
        function loadData() {
            ...
            $.ajax({
                type: 'GET',
                url: "{{ url('pltmh-santong/log/load-data?generator_id=') }}" + generator_id + "&date=" +
        ...
        $(document).on('click', '.btn-submit-export', function(e) {
            e.preventDefault()
            url = "{{ url('pltmh-santong/log/export') }}" + '?date=' + $('#date').val()
